...
export const editCourse = async (req, res) => {
  try {
    ...
    if (thumbnail) {
      ...
      // upload a thumbnail from cloudinary
...
export const removeLecture = async (req, res) => {
  try {
    ...
    const course = await Course.updateOne(
      { lectures: lectureId }, // find the course that containes the lecture
      { $pull: { lectures: lecture._id } } // Remove the lectures id from the lectures array
    );
